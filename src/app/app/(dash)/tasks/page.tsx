...
const mockTasks: Task[] = [
  {
    id: '1',
    title: 'Add urgency timer to product page',
    description: 'CR below 1.2%. Countdown + low-stock badge could lift CR 15-30% (4 creator consensus).',
    priority: 'high',
    owner: 'mers',
    column: 'suggested',
    impact: '↑ Est. +22% CR',
  ...
  {
    id: '2',
    title: 'Switch to broad targeting on Meta',
    description: 'Interest-stack CPM at $38. Broad + Advantage+ drops CPM to $18-24.',
    priority: 'high',
    owner: 'mers',
    column: 'suggested',
    impact: '↓ Est. -35% CPM',
  ...
  {
    id: '3',
    title: 'Launch TikTok Ads — organic-style hooks',
    description: 'TikTok CPMs 40-60% lower than Meta for fitness/beauty. Test 3 native-feel creatives.',
    priority: 'high',
    owner: 'mers',
    column: 'backlog',
    impact: '↓ Est. -45% CPM',
  ...
  {
    id: '4',
    title: 'Meta Ads campaign restructure',
    description: 'Splitting into CBO broad + 3 ASC creatives. Kill: pause if CPP > $25 after 72h.',
    priority: 'high',
    owner: 'mers',
    column: 'progress',
    impact: '↓ Est. -$8K/mo wasted spend',
    createdAt: new Date().toISOString(),
  },
];
